...
//   function disableAutocompleteTemporarily(inputEl) {
//     inputEl.setAttribute('autocomplete', 'off');
//     inputEl.blur(); // забрати фокус
//     setTimeout(() => {
//       inputEl.setAttribute('autocomplete', 'on');
//     }, 500); // через півсекунди повернути автокомпліт
//   }
...
//   let suppressBlurHandler = false; // додали для контролю blur
...
//           // 🔒 блокуємо blur-перевірку
//           suppressBlurHandler = true;
//           fromInput.value = address;
//           fromInput.dispatchEvent(new Event('input', { bubbles: true }));
//           disableAutocompleteTemporarily(fromInput);
//           setTimeout(() => {
//             suppressBlurHandler = false;
//           }, 500);
//         } else {
//           if (manualToMarker) manualToMarker.setMap(null);
//           manualToMarker = new Marker({
...
//           disableAutocompleteTemporarily(toInput);
//           setTimeout(() => {
//             suppressBlurHandler = false;
//           }, 500);
//         }
